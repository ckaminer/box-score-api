const game = {
  ...
  away_batters: [
    {
      ...
      obp: 0,
      slg: 0,
      at_bats_per_home_run: 0,
      at_bats_per_rbi: 0,
      walk_rate: 0,
      plate_appearances_per_rbi: 0,
      plate_appearances_per_home_run: 0,
      extra_base_hits: 0,
      stolen_base_average: 0,
      strikeout_rate: 0,
      ops_string: '.000',
      slg_string: '.000',
      obp_string: '.000',
    ...
    },
    {
      ...
      obp: 0.25,
      slg: 1,
      at_bats_per_home_run: 4,
      at_bats_per_rbi: 4,
      walk_rate: 0,
      plate_appearances_per_rbi: 4,
      plate_appearances_per_home_run: 4,
      extra_base_hits: 1,
      stolen_base_average: 0,
      strikeout_rate: 0,
      ops_string: '1.250',
  ...
  home_batters: [
    ...
    },
    {
      ...
      at_bats_per_rbi: 2,
      walk_rate: 0,
      plate_appearances_per_rbi: 2,
      plate_appearances_per_home_run: 0,
      extra_base_hits: 1,
      stolen_base_average: 1,
      strikeout_rate: 0,
      ops_string: '1.250',
      slg_string: '.750',
      obp_string: '.500',
  ...
  away_batter_totals: {
    ...
    obp: 0.265,
    slg: 0.31,
    at_bats_per_home_run: 29,
    at_bats_per_rbi: 9.667,
    walk_rate: 0.118,
    plate_appearances_per_rbi: 11.333,
    plate_appearances_per_home_run: 34,
    extra_base_hits: 2,
    stolen_base_average: 0,
